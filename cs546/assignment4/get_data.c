...
main(int argc, char** argv) {
	...
	dest = p - 1;	/*Set Destination Rank to p-1 */


/* Add up the integrals calculated by each process */ 
	/* If you are the collector (process with largest rank) */
	if (my_rank == p-1) {

        total = integral;
		/*For all processes that have a lesser rank */
	...
	/* Otherwise you are sending your data to the collector */
    } else {   
